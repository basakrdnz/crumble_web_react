...
const Story = () => {
  ...
  return (
    <section id="story" className="py-20 bg-gradient-to-b from-amber-50 to-white">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-amber-700 text-sm">El Yapımı</div>
              </div>
            </div>
          </div>
        </div>
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-amber-100 rounded-full mb-4">
                  <span className="text-2xl font-bold text-amber-800">{milestone.year}</span>
                </div>
                <h4 className="text-xl font-semibold text-amber-900 mb-2">{milestone.title}</h4>
