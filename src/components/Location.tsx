...
const Location = () => {
  const hours = [
    { day: 'Pazartesi - Cuma', time: '07:00 - 21:00' },
    { day: 'Cumartesi', time: '08:00 - 22:00' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-amber-700 max-w-3xl mx-auto leading-relaxed">
            Crumble'ın sıcaklığını deneyimleyin. Şehrin kalbinde uygun konumumuzda, 
            harika yemekler ve samimi hizmetle sizi karşılamaya hazırız.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700">(0216) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700">merhaba@crumblecafe.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 rounded-lg p-8">
              <h3 className="text-2xl font-bold text-amber-900 mb-6">Çalışma Saatleri</h3>
              <div className="space-y-3">
                {hours.map((schedule, index) => (
                  <div key={index} className="flex justify-between items-center">
                    <span className="text-amber-900 font-medium">{schedule.day}</span>
            ...
            <div className="bg-amber-50 rounded-lg p-8">
              <h3 className="text-2xl font-bold text-amber-900 mb-6">Nasıl Gelir</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Car className="h-6 w-6 text-amber-600 mt-1" />
                  <div>
                    <h4 className="font-semibold text-amber-900">Arabayla</h4>
                    <p className="text-amber-700">Bağdat Caddesi ve yan sokaklarda ücretsiz park imkanı</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Bus className="h-6 w-6 text-amber-600 mt-1" />
                  <div>
                    <h4 className="font-semibold text-amber-900">Toplu Taşıma</h4>
                    <p className="text-amber-700">15 ve 23 numaralı otobüs durakları sadece 2 dakika yürüme mesafesinde</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-amber-100 rounded-lg p-8 h-64 flex items-center justify-center">
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold text-amber-900 mb-2">İnteraktif Harita</h4>
                <p className="text-amber-700">
                  Bağdat Caddesi No: 123, Kadıköy/İstanbul
                </p>
                <button className="mt-4 bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-full font-medium transition-colors">
                  Yol Tarifi Al
                </button>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-lg p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Ziyaret Etmeye Hazır mısınız?</h3>
              <p className="mb-6">
                Lezzetli, sağlıklı yemeklerimizi size sunmak için sabırsızlanıyoruz. 
                Unutulmaz bir yemek deneyimi için bize katılın!
              </p>
